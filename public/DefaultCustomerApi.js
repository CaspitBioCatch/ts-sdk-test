...
(function (exports) {
    ...
    exports.cdApi = {
        ...
        getConfigurations: function (callback) {
            ...
            configurations['useUrlWorker'] = true;
        ...
        // Additional client methods for TypeScript SDK compatibility
        client: {
            flush: function() {
                window.postMessage({ type: 'cdFlush' }, window.location.href);
            },
            
            setCoordinatesMasking: function(isEnable) {
                window.postMessage({ type: 'cdSetCoordinatesMasking', isEnable: isEnable }, window.location.href);
            }
        }
    };
