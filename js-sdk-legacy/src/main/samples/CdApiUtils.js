...
export function attachCdApi() {
  ...
  window.cdApi = {
    ...
    getConfigurations: function (callback) {
      ...
      configurations['wupServerURL'] = getMetatagContent('cdConfLocation') || 'https://wup-4ff4f23f.eu.v2.we-stats.com/client/v3.1/web/wup?cid=dummy';
